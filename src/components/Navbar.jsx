          ...
          <Drawer isOpen={isOpen} onClose={onClose} placement="left" finalFocusRef={menuButtonRef}>
            ...
            <DrawerContent>
              ...
              <DrawerHeader as={Flex} justify="center">
                <Link as={ReactRouterLink} to="/">
                  <Image boxSize="120px" objectFit="contain" src="/cofeeco_logo.png" alt="SOSE Logo" />
                </Link>
              </DrawerHeader>
          ...
          >
            ...
            >
              <Link
                ...
                as={ReactRouterLink}
                to={"https://www.facebook.com/cofeeco.in"}
              >
              ...
              <Link
                ...
                isExternal={true}
                as={ReactRouterLink}
                to={"https://www.youtube.com/@cofeeco"}
              >
            ...
            >
              ...
              <Link
                ...
                as={ReactRouterLink}
                to={
                  "https://play.google.com/store/apps/details?id=com.sose.co.fee.co"
                }
              >
